...
const BusinessCard = () => {
  ...
  return (
    <div className="border-[1px] flex flex-col rounded-2xl gap-4 border-zinc-700 p-8 hover:bg-zinc-900 hover:border-[#000000] hover:-translate-y-[2.5px] transition-all duration-200 ">
